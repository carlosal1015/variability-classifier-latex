...
% @IMAGE: Add image showing how transformation to higher dimension can make the proble linearly separable
...
% Probably the way humans would do classification
...
\end{equation}
% From this we can define the information gain...
...
% Subdivide (split) data at each branch into two sets
% Boundaries axis aligned (so same split-feature at same level)
% Recursive splitting until some stop--criteria is fulfiled (recursive partioning)
% Top-down induction of decision trees 
% CART: Classification And Regression Tree
% Classification is performed by simpling walking down the tree
% Leaf nodes determine label
